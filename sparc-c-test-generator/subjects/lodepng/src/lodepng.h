...
/* ////////////////////////////////////////////////////////////////////////// */
/* Exposed internal utility functions for testing                           */
/* ////////////////////////////////////////////////////////////////////////// */

/*Read a 4-byte big-endian unsigned integer from buffer.*/
unsigned lodepng_read32bitInt(const unsigned char* buffer);

/*Write a 4-byte big-endian unsigned integer to buffer.*/
void lodepng_set32bitInt(unsigned char* buffer, unsigned value);

/*Reverse the given number of bits.*/
...
/*Check if colortype and bitdepth are a valid combination. Returns 0 if valid, error code otherwise.*/
unsigned checkColorValidity(LodePNGColorType colortype, unsigned bd);

/*Return number of color channels for the given color type.*/
unsigned getNumColorChannels(LodePNGColorType colortype);

/*Return bits per pixel for the given color type and bit depth.*/
unsigned lodepng_get_bpp_lct(LodePNGColorType colortype, unsigned bitdepth);

/*Check if two color modes are equal. Returns 1 if equal, 0 if not.*/
int lodepng_color_mode_equal(const LodePNGColorMode* a, const LodePNGColorMode* b);

/*Get raw pixel data size in bytes from width, height, color type and bit depth.*/
size_t lodepng_get_raw_size_lct(unsigned w, unsigned h, LodePNGColorType colortype, unsigned bitdepth);

/*Check if pixel buffer size would overflow. Returns 1 if overflow, 0 if safe.*/
int lodepng_pixel_overflow(unsigned w, unsigned h,
                           const LodePNGColorMode* pngcolor, const LodePNGColorMode* rawcolor);

/*Returns how many bits are needed to represent the given value (max 8 bit).*/
unsigned getValueRequiredBits(unsigned char value);

/*Paeth predictor used in PNG filtering. Returns predicted value from three neighbor bytes.*/
unsigned char paethPredictor(short a, short b, short c);

/*Unfilter a single PNG scanline. filterType is 0-4.*/
unsigned unfilterScanline(unsigned char* recon, const unsigned char* scanline, const unsigned char* precon,
                          size_t bytewidth, unsigned char filterType, size_t length);

/*Filter a single PNG scanline. filterType is 0-4.*/
